...
$("form").on("submit", function (event) {
    ...
    if ($("#add").is(":visible")) {
        ...
        pessoas[pessoas.indexOf(update)] = dados //pessoas.indexOf(update) percorre a lista e procura a posição que estava o update
        console.log("updated");
                ...
                $("<td>").append(
                    ...
                    $('<button>', {
                        ...
                        click: function () {
                            ...
                            pessoas.splice(pessoas.indexOf(pessoa)) // SPLICE = REMOVER
                            console.log("REMOVED");
                            escreverTabela();
...
// $('<button>', { text: "12",
// class:"btn fw-bolder btn-info btn-sm mt-2 mb-2" }).appendTo("body") //$("< >") = CRIA NOVO ELEMENTO //$(" ") = BUSCA ELEMENTO
// $('<div>').append(
//     $('<img>', {
